		...
		<div class="user-book-main-rm">
			<ul>
				<c:forEach items="${pageBean.list }" var="borrow">
					<li>
						<a href="#">
							<img src="${pageContext.request.contextPath }/${borrow.book.photo}">
						...
						<div class="user-book-shop-nb">
							...
							<span class="us-bk-all user-riq">借阅日期<a href="javascript:;">2017年8月10号</a></span>
							<span class="us-bk-all user-jh">借还状态:<a href="javascript:;">未还</a></span>
							<span class="us-bk-all user-jyr">
								书主:<a href="">未知</a>
								<a class="us-bk-del" href="javascript:;">还书</a>
							</span>
						</div>
					</li>
				</c:forEach>
