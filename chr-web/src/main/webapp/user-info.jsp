...
<body>
	<div class="user-main-r">
		<div class="user-main-rt">个人信息</div>
		<form class="user-main-rm" action="" method="post">
			...
			<div class="user-main-rmc">
				<span>昵称</span> <input type="text" name="username"
					readonly="readonly" value="${user.nick }">
			</div>
			<div class="user-main-rmc">
				<span>学号</span> <input type="text" name="username"
					readonly="readonly" value="${user.stuid }">
			</div>
			<div class="user-main-rmc">
				<span>学院 | 专业</span> <input type="text" name="username"
					readonly="readonly" value="${user.college } | ${user.major }">
			</div>

			<div class="user-main-rmc">
				<span>个性签名</span> <input type="text" name="username"
					readonly="readonly" value="${user.word }">
			</div>
			<div class="user-main-rmc">
				<input id="user-main-rmcs" type="submit" name="username"
					value="确定更改">
			</div>
		</form>
	</div>
