	...
	<div id="main">
		...
		<div class="shop">
			<div class="shop_wrap">
				<div class="shop_gn">
					<a
						href="${pageContext.request.contextPath }/bookAction_findAllList"><span
						class="glyphicon glyphicon-home"></span></a>
					<h4>南航书院</h4>
					<p>
						我们的共享图书馆<br />随时随地上传和借阅图书
					</p>
				</div>
				
				<div class="shop_gn">
					<a
						href="${pageContext.request.contextPath }/lostAction_findLost"><span
						class="glyphicon glyphicon-home"></span></a>
					<h4>失物招领</h4>
					<p>
						我们的共享图书馆<br />随时随地上传和借阅图书
				...
				<div class="shop_gn">
					<a href="${pageContext.request.contextPath }/chat.jsp"><span
						class="glyphicon glyphicon-home"></span></a>
					<h4>南航书院</h4>
					<p>
						我们的共享图书馆<br />随时随地上传和借阅图书
				...
				<div class="shop_gn">
					<a href="book.html"><span class="glyphicon glyphicon-home"></span></a>
					<h4>南航书院</h4>
					<p>
						我们的共享图书馆<br />随时随地上传和借阅图书
					</p>
