...
<body>
 ...
 -->
	...
	<div id="to_top">
		<a href="#header"
			style="width: 50px; height: 50px; display: block; cursor: pointer;"><span
			class="glyphicon glyphicon-arrow-up" style="color: #FFF;"></span></a>
	</div>
	<!-- 页头 -->
	<div id="header_book">
		<!-- 导航栏 -->
		...
		<div class="book_theme">
			<div class="book-theme-title">
				<span>南航书院</span>
				<p>
					<img class="aligncenter" src="images/line.png" alt="&quot;img">
				</p>
		...
		<div class="book_nav">
			<div class="book-nav-l">
				<div class="book-nav-button">
					<span class="book-nav-ls"> 分类&nbsp;<span
						class="glyphicon glyphicon-menu-down" style="font-size: 14px"></span>
					</span>
			...
			<div class="book-nav-r">
				<form class="book-nav-rb">
					<input type="text" name="" class="search-text"
						placeholder="搜索书名或作者名"><input type="submit" name=""
		...
		<div class="book-info">
			<div class="book-info-main">
				<div class="biml">
					<div class="biml-t">
						<img id="biml-img"
							src="${pageContext.request.contextPath }/${book.photo}">
					</div>
					<div class="biml-b">
						<ul>
							<li onmouseover="bookch1('${book.photo}')"><img
								src="${pageContext.request.contextPath }/${book.photo}"></li>
							<li onmouseover="bookch2()"><img
								src="images/book-infor-2.jpg"></li>
							<li onmouseover="bookch3()"><img
								src="images/book-infor-3.jpg"></li>
							<li onmouseover="bookch4()"><img
								src="images/book-infor-4.jpg"></li>
							<li onmouseover="bookch5()"><img
								src="images/book-infor-5.jpg"></li>
						</ul>
					</div>
				</div>
				<div class="bimr">
					<p class="book-inq">
						...
						<span class="book-font">书名:&nbsp;</span><span
							style="color: #08AF96">${book.name }</span><br>
						<br> <span>出版社:</span><span style="color: #08AF96">${book.press }</span><br>
						<br> <span>出版日期:</span><span style="color: #08AF96">2017年8月</span><br>
						<br> <span>本书介绍:</span><span style="color: #08AF96">&nbsp;${book.description }</span><br>
						<br> <span>贡献人:</span><a href="#">${book.user.name }</a><br>
						<br> <span>借阅状态:</span><a href="#">可借</a>
					</p>
				</div>
			</div>
		</div>
	...
	<div class="commentAll">
		...
		<div class="reviewArea clearfix">
			<textarea class="content comment-input" placeholder="书友评论&hellip;"
					...
					<div class="comment-show-con clearfix">
						...
						<div class="comment-show-con-list pull-left clearfix">
							<div class="pl-text clearfix">
								<a href="#" class="comment-size-name">${comment.user.nick }
									: </a> <span class="my-pl-con">&nbsp;${comment.messageContent }</span>
							</div>
							<div class="date-dz">
								...
								<div class="date-dz-right pull-right comment-pl-block">
									<a href="javascript:;" class="removeBlock">删除</a> <a
										href="javascript:;"
										class="date-dz-pl pl-hf hf-con-block pull-left"> 回复 <!--  隐藏域为此评论的唯一标识 -->
										<input type="hidden" id="commentNumber" name="commentNumber"
										value="${comment.messageNum }" />

									</a> <span class="pull-left date-dz-line">|</span> <a
										...
										<c:if test="${comment1.rootNumber==comment.rootNumber }">
											...
											<div class="all-pl-con">
												<div class="pl-text hfpl-text clearfix">
													<a href="#" class="comment-size-name">${comment1.user.nick}
														: </a> <span class="my-pl-con">回复<a href="#"
														class="atName">@${comment1.message.user.nick }</a> :
														${comment1.messageContent }
													</span>
												</div>
												<div class="date-dz">
													<span class="date-dz-left pull-left comment-time">2017-12-01
														11:51:10.0</span>
													<div class="date-dz-right pull-right comment-pl-block">
														<a href="javascript:;" class="removeBlock">删除</a> <a
															href="javascript:;"
															class="date-dz-pl pl-hf hf-con-block pull-left"> 回复 <!--  隐藏域为此评论的唯一标识 -->
															<input type="hidden" id="commentNumber"
															name="commentNumber" value="${comment1.messageNum }" />
