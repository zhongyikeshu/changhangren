	...
	<div class="user-main-r">
		...
		<form class="user-main-rm" action="" method="post">
			...
			<div class="user-main-rmc">
				<span>书名</span> <input type="text" name="username" value="西游记">
			</div>
			<div class="user-main-rmc">
				<span>作者</span> <input type="text" name="username" value="吴承恩">
			</div>
			<div class="user-main-rmc">
				<span>出版社</span> <input type="text" name="username" value="人民出版社">
			</div>
			<div class="user-main-rmc">
				<span>图书简介</span> <input type="text" name="username"
					value="讲述了师徒五人西天取经的故事">
			</div>
			<!-- <div class="user-main-rmc">
				<span>专业</span>
