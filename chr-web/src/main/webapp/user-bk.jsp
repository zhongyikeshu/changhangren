...
<body>
	<div class="user-book-main-r">
		<div class="user-main-rt">我的图书</div>
				...
				<c:forEach items="${pageBean.list }" var="book">
					<li><a href="#"> <img
						...
						<div class="user-book-shop-nb">
							<span class="us-bk-all user-shum">书名:${book.name }</span> <span
								class="us-bk-all user-zuozhe">作者:${book.author }</span> <span
								class="us-bk-all user-chuban">出版社:${book.press }</span> <span
								class="us-bk-all user-riq">上传日期<a href="javascript:;">2017年8月10号</a></span>
							<span class="us-bk-all user-jh">借还状态:<a
								href="javascript:;">已被借</a></span> <span class="us-bk-all user-jyr">
								借阅人:<a href="">未知</a> <a class="us-bk-del" href="javascript:;"
