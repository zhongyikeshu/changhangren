...
<body>
	<div class="user-book-main-r">
		<div class="user-main-rt">我的借阅</div>
		<div class="user-book-main-rm">
			<ul>
				<c:forEach items="${pageBean.list }" var="borrow">
					<li><a href="#"> <img
							src="${pageContext.request.contextPath }/${borrow.book.photo}">
							<div class="user-book-mask">
								<button onclick="xiangqing()">查看详情</button>
							</div>
					</a>
						<div class="user-book-shop-nb">
							<span class="us-bk-all user-shum">书名:${borrow.book.name }</span>
							<span class="us-bk-all user-zuozhe">作者:${borrow.book.author }</span>
							<span class="us-bk-all user-chuban">出版社:${borrow.book.press }</span>
							<span class="us-bk-all user-riq">借阅日期<a
								href="javascript:;">2017年8月10号</a></span> <span
								class="us-bk-all user-jh">借还状态:<a href="javascript:;">未还</a></span>
							<span class="us-bk-all user-jyr"> 书主:<a href="">未知</a> <a
								class="us-bk-del" href="javascript:;">还书</a>
							</span>
						</div></li>
				</c:forEach>
			</ul>
	...
	<form id="query3"
		action="${pageContext.request.contextPath}/bookAction_pageQuery2"
		method="post">
		<input id="cid" type="hidden" name="cid" value=""> <input
			id="keyWord" type="hidden" name="keyWord" value=""> <input
			id="currentPage" type="hidden" name="currentPage" value=""> <input
			id="pageSize" type="hidden" name="pageSize" value="">
	</form>
</body>
</html>